...
public class Thor extends Walker{
    ...
    private static final Shape ImShape = new PolygonShape( 
     ...
     private   BodyImage image = new BodyImage("data/Thor/Standing.gif",09f);
    
    /**
     *Constructor showing inheritance from its superclass, World
     * @param world
     */
    public Thor(GameLevel world) {
        super(world, ImShape);
     addImage(image);
        life =100;
    } 
    ...
    public void decLife(float r){
        life = life - r;
        System.out.println("ThorLife: " + life);
    }

    /**
     *Adds my chosen image to the Thor character
     * @param Image
     */
